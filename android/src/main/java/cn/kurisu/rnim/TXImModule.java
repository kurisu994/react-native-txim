...
import cn.kurisu.rnim.business.InitBusiness;
import cn.kurisu.rnim.business.LoginBusiness;
import cn.kurisu.rnim.event.MessageEvent;
import cn.kurisu.rnim.presenter.ChatPresenter;
import cn.kurisu.rnim.presenter.ConversationPresenter;
import cn.kurisu.rnim.utils.PushUtil;
import cn.kurisu.rnim.utils.ReactCache;

import static android.content.Context.NOTIFICATION_SERVICE;
import static cn.kurisu.rnim.utils.ReactCache.observeRecentContact;
        ...
        LoginBusiness.loginIm(identify, userSig, new TIMCallBack() {
            ...
            public void onSuccess() {
                ...
                if (deviceMan.equals("Xiaomi") && shouldMiInit()) {
                    MiPushClient.registerPush(getReactApplicationContext().getApplicationContext(),
                            "2882303761517877217", "5741787744217");
                ...
                if (MzSystemUtils.isBrandMeizu(getReactApplicationContext().getApplicationContext())) {
                    com.meizu.cloud.pushsdk.PushManager.register(getReactApplicationContext().getApplicationContext(),
                            "1002203", "bc53fc5508374d6896803699132d36f9");
                }
                promise.resolve(true);
            }
        });
